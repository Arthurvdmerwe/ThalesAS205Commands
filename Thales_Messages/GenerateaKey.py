...
class GenerateKey:
    ...
    def get_commandDecrypt_a_PIN_Pad_Public_Key(self, Mac, Manufacturer_Public_Key, sMSK_PPPK):
        command_code = 'H0'
        key_encoding = '01'
        mac = Mac
    ...
    def execute_Decrypt_a_PIN_Pad_Public_Key(self, Mac, Manufacturer_Public_Key, sMSK_PPPK):
        response = Connector.Thales9000().SendMessage(self.get_commandDecrypt_a_PIN_Pad_Public_Key(Mac, Manufacturer_Public_Key, sMSK_PPPK))
        return response
